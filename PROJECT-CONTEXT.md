...
## Special Screens
- **Approval Policy Builder**: Rule form (IF amount > $10,000 AND currency != base currency THEN Finance Manager + CFO approval). Avoid overly complex visual node editors; keep the rule form clear.
